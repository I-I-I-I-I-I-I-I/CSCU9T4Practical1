...
public class sprintEntryTest {
    ...
    public void testGetName() {
        ...
        Entry instance = new sprintEntry("Alice", 1, 2, 2003, 0, 16, 7, "300m", 4, 2);
    ...
    public void testGetDistance() {
        ...
        sprintEntry instance = new sprintEntry("Alice", 1, 2, 2003, 0, 16, 7, "300m", 4, 2);
        String expResult = "300m";
    ...
    public void testGetRecovery() {
        ...
        sprintEntry instance = new sprintEntry("Alice", 1, 2, 2003, 0, 16, 7, "300m", 4, 2);
        int expResults = 2;
        int result = instance.getRestTime();
        assertEquals(expResults, result);
    }
