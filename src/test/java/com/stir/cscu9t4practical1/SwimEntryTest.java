...
public class SwimEntryTest {
    ...
    public void testGetName() {
        ...
        Entry instance = new SwimEntry("Alice", 1, 2, 2003, 0, 16, 7, "3m","outdoors");
    ...
    public void testGetDay() {
        ...
        Entry instance = new SwimEntry("Alice", 1, 2, 2003, 0, 16, 7, "3m","pool");
        int expResult = 1;
    ...
    public void testGetWhere() {
        ...
        SwimEntry instanceA = new SwimEntry("Alice", 1, 2, 2003, 0, 16, 7, "3m","outdoors");
        String expResultA = "outdoors";
        String result = instanceA.getInOut();
    ...
    public void testGetEntry() {
        ...
        Entry instance = new SwimEntry("Alice", 1, 2, 2003, 0, 16, 7, "3m","outdoors");
        String expResult = "Alice swam 3m outdoors in 0:16:7 on 1/2/2003\n";
